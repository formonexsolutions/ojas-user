...
import 'package:ojas_app/Pandit/PanditControllers/Pandit_AuthController/pandit_authController.dart';
import 'package:ojas_app/Utils/custom_button.dart';

import 'package:firebase_core/firebase_core.dart';

class PanditSignupPage extends StatelessWidget {
              ...
              children: [
                ...
                Obx(() {
                  ...
                  return CustomButton(
                    ...
                    onPressed: ()=>authController.Panditregister(
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => Get.toNamed('/pandit-login'),
                      child: Text('Sign In',
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                              fontSize: screenWidth * 0.04,
