...
class PanditBookingHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.panditBookings.isEmpty) {   // use panditBookings here
          return const Center(child: Text("No bookings yet"));
        }
        return ListView.builder(
          itemCount: controller.panditBookings.length,
          itemBuilder: (context, index) {
            var booking = controller.panditBookings[index];
            return Card(
