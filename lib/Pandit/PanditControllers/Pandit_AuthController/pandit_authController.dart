...
class PanditAuthController extends GetxController {
  ...
  Future<void> Panditregister({
    ...
    try {
      ...
      await _firestore.collection('pandit').doc(uid).set({
        'name': name,
        'email': email,
        'mobile':mobile,
        "address":address,
  ...
  void Panditlogin(String email, String password) async {
