  ...
  void _loadFestivals() {
    festivals.value = const [
      Festival(
        ...
        description:
           "Diwali, also known as Deepavali, is one of the most important and widely celebrated festivals in India. It symbolizes the victory of light over darkness and good over evil. Celebrated by millions of Hindus, Sikhs, Jains, and even Buddhists, Diwali marks the return of Lord Rama to Ayodhya after defeating Ravana, according to Hindu mythology."
      ),
      Festival(
        name: "Holi",
        date: "14 Mar 2025",
        ...
        description:
          "Holi is a vibrant and joyful festival celebrated across India, known as the Festival of Colors. It marks the arrival of spring and the victory of good over evil, rooted in the legend of Prahlad and Holika. On this day, people of all ages come together to play with colored powders (gulal), splash water, sing, dance, and celebrate without any social barriers. Bonfires are lit on the eve of Holi, known as Holika Dahan, to symbolize the burning away of evil.",
